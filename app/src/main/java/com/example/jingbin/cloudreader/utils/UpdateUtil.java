...
public class UpdateUtil {
    ...
    public static void check(final Activity activity, final boolean isShowToast) {
        ...
        Subscription get = HttpClient.Builder.getFirServer()
            ...
            .subscribe(new Observer<UpdateBean>() {
                ...
                @Override public void onNext(final UpdateBean updateBean) {
                    ...
                    builder.setPositiveButton("立即下载",
                        (dialogInterface, i) -> BaseTools.openLink(activity, updateBean.getInstallUrl()));
                    builder.show();
                }
            });
        //        addSubscription(get);
