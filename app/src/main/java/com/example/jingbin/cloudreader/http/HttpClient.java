...
public interface HttpClient {
     ...
     * 玩安卓轮播图
     */
    @GET("banner/json") Observable<WanAndroidBannerBean> getWanAndroidBanner();
     ...
     */
    @GET("data/{type}/{pre_page}/{page}") Observable<GankIoDataBean> getGankIoData(@Path("type") String id,
     ...
     */
    @GET("day/{year}/{month}/{day}") Observable<GankIoDayBean> getGankIoDay(@Path("year") String year,
        @Path("month") String month, @Path("day") String day);

    /**
     * 豆瓣热映电影，每日更新
     */
    @GET("v2/movie/in_theaters") Observable<HotMovieBean> getHotMovie();
     ...
     */
    @GET("v2/movie/top250") Observable<HotMovieBean> getMovieTop250(@Query("start") int start,
     ...
     */
    @GET("v2/book/search") Observable<BookBean> getBook(@Query("tag") String tag, @Query("start") int start,
        @Query("count") int count);

    @GET("v2/book/{id}") Observable<BookDetailBean> getBookDetail(@Path("id") String id);

    /**
     * @param id 应用id
     * @param apiToken token
     */
    @GET("latest/{id}") Observable<UpdateBean> checkUpdate(@Path("id") String id, @Query("api_token") String apiToken);
     ...
     * @param page 页码，从1开始
     */
    @GET("article/list/text") Observable<QsbkListBean> getQsbkList(@Query("page") int page);
     ...
     * @param cid 体系id
     */
    @GET("article/list/{page}/json") Observable<HomeListBean> getHomeList(@Path("page") int page,
     ...
     * @param password 密码
     */
    @FormUrlEncoded @POST("user/login") Observable<LoginBean> login(@Field("username") String username,
        @Field("password") String password);

    /**
     * 玩安卓注册
     */
    @FormUrlEncoded @POST("user/register") Observable<LoginBean> register(@Field("username") String username,
        @Field("password") String password, @Field("repassword") String repassword);

    /**
     * 退出
     */
    @GET("user/logout/json") Observable<LoginBean> logout();
     ...
     * @param page 页码
     */
    @GET("lg/collect/list/{page}/json") Observable<HomeListBean> getCollectList(@Path("page") int page);
     ...
     * @param id 文章id
     */
    @POST("lg/collect/{id}/json") Observable<HomeListBean> collect(@Path("id") int id);
     ...
     * @param id 文章id
     */
    @POST("lg/uncollect_originId/{id}/json") Observable<HomeListBean> unCollectOrigin(@Path("id") int id);
     ...
     */
    @FormUrlEncoded @POST("lg/uncollect/{id}/json") Observable<HomeListBean> unCollect(@Path("id") int id,
        @Field("originId") int originId);

    /**
     * 体系数据
     */
    @GET("tree/json") Observable<TreeBean> getTree();
     ...
     * @param link 链接
     */
    @FormUrlEncoded @POST("lg/collect/addtool/json") Observable<HomeListBean> collectUrl(@Field("name") String name,
     ...
     * @param link 链接
     */
    @FormUrlEncoded @POST("lg/collect/updatetool/json") Observable<HomeListBean> updateUrl(@Field("id") int id,
        @Field("name") String name, @Field("link") String link);
     ...
     * @param id 收藏网址id
     */
    @FormUrlEncoded @POST("lg/collect/deletetool/json") Observable<HomeListBean> unCollectUrl(@Field("id") int id);

    /**
     * 收藏网站列表
     */
    @GET("lg/collect/usertools/json") Observable<CollectUrlBean> getCollectUrlList();

    /**
     * 导航数据
     */
    @GET("navi/json") Observable<NaviJsonBean> getNaviJson();
