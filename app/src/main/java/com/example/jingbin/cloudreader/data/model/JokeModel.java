...
public class JokeModel {
    ...
    public void showQSBKList(final WanNavigator.JokeModelNavigator listener, int page) {
        Func1<QsbkListBean, Observable<List<DuanZiBean>>> func1 =
            new Func1<QsbkListBean, Observable<List<DuanZiBean>>>() {
                @Override public Observable<List<DuanZiBean>> call(QsbkListBean bean) {
        ...
        Subscription subscription = HttpClient.Builder.getQSBKServer()
            .getQsbkList(page)
            .flatMap(func1)
